...
from CEF_SiAEnvironmentV3Core5 import Environment
import random
import timeit 
...
temp =[]
record_best_value=[]
start_Decisin_time = timeit.default_timer()
...
for m in range(len(intial_actions)):   
    ...
    for n in range(len(intial_actions[m])):    
        ...
        Num_attampts = 25 # How many times search the neighbour before decrease the temprature (num actions)
        ...
        # Get total arrival traffic in site
                ...
                print("Arivl Traffic -------------",m,n,trafic[m])
                print("  ")
                print("Capacity ------------",m,n, capacity)
                print("  ")
                print("Difference value ----",m,n,residual_value)
...
obs, latency_final,reward_final, done = env.step(intial_actions)
print(" ")
print("new_actions",new_actions)
latency = latency_final
reward = reward_final
  
stop_Decisin_time = timeit.default_timer()
print(" ")
print(" ")
...
print("Reward = ", reward)
print(" ")
Decision_time = stop_Decisin_time - start_Decisin_time
print("Program Executed in "+str(Decision_time))
print(" ")
...
with open("resultLatency.txt", "a+") as file_object:
    ...
    file_object.write("\n")
    file_object.write("Decision_time in ")
