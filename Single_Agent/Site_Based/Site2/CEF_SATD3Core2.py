...
from CEF_SAEnvironmentCore2 import Environment
# from CEF_SAEnvironmentCore2V2 import Environment
...
# From the new state s’, the Actor target plays the next action a’
      l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16 = self.actor_target(new_state)
      next_action = torch.cat([l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16],1)
...
# Once every two iterations, we update our Actor model by performing gradient ascent on the output of the first Critic model
      ...
      l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16 = self.actor(state)
      action = torch.cat([l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16],1)
...
# We increase the total reward
    ...
    e_reward.append(episode_reward)
    action = actionsave
# We store the new transition into the Experience Replay memory (ReplayBuffer)
    ...
    replay_buffer.Transitions((obs, new_obs, action, episode_reward, done_bool))
