...
from CEF_SAEnvironmentCore3 import Environment
...
class Actor_Network(nn.Module):
  ...
  def forward(self, stat):                         
    ...
    return l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24
...
# From the new state s’, the Actor target plays the next action a’
      l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24 = self.actor_target(new_state)
      next_action = torch.cat([l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24],1)
...
# Once every two iterations, we update our Actor model by performing gradient ascent on the output of the first Critic model
      ...
      l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24 = self.actor(state)
      action = torch.cat([l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24],1)
...
def evaluate_policy(policy, eval_episodes=10):
    ...
    for i in range(eval_episodes):
        ...
        avg_reward = total_reward /(env.NumAcceNetwork)
...
policy_net_update = 2         #Number of iterations to wait before the policy network (Actor 
