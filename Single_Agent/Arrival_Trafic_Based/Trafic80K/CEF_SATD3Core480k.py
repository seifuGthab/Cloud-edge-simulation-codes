...
from CEF_SAEnvironmentCore480k import Environment
...
class Actor_Network(nn.Module):
  ...
  def forward(self, stat):                         
    ...
    return l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24,l25,l26,l27,l28,l29,l30,l31,l32
...
class Agent(object):
  ...
  def learn(self, replay_buffer, iterations, batch_size=100, disc_factor=0.99,
            learning_rate=0.01, noise=0.2,noise_clip=0.5, policy_net_update=2):
...
# From the new state s’, the Actor target plays the next action a’
      l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24,l25,l26,l27,l28,l29,l30,l31,l32 = self.actor_target(new_state)
      next_action = torch.cat([l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24,l25,l26,l27,l28,l29,l30,l31,l32],1)
...
# Once every two iterations, we update our Actor model by performing gradient ascent on the output of the first Critic model
      if itr % policy_net_update == 0:
          ...
          l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24,l25,l26,l27,l28,l29,l30,l31,l32 = self.actor(state)
          action = torch.cat([l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,l21,l22,l23,l24,l25,l26,l27,l28,l29,l30,l31,l32],1)
...
def evaluate_policy(policy, eval_episodes=10):
    ...
    for _ in range(eval_episodes):
        ...
        while not done:
            ...
            total_reward += reward
            if indexx % 10 ==0:
                # print("AN Traffic = ", env.AN)
                # print("CN Traffic = ", env.CN)
                # print("step = ", env.steps_left)
                rew.append(reward)
    ...
    # avg_latency = total_latency/eval_episodes    
...
max_action=1.0
noise = 0.2  #Exploration noise - STD value of exploration Gaussian noise
layer1_size = 400
layer2_size = 300
...
# stop_dtime = timeit.default_timer()
# decision_time = stop_dtime - start_dtime
evl_reward = evaluate_policy(policy)


# pyplot.figure(1)
# pyplot.title("Reward")
# pyplot.plot(evaluations, marker="x")
# pyplot.show()
...
with open("TrainResults.txt", "a+") as file_object:
    ...
    file_object.write("\n")
    file_object.write("Evalutions = ")
    file_object.write(str(evaluations))
    file_object.write("\n")
    file_object.write("ep_reward = ")
...
# print ("Average Latency: %.10f" % (evl_latency))
# print ("Average Reward: %.10f" % (evl_reward))
...
pyplot.plot(evaluations, marker="+")
pyplot.show()
...
def evaluate_policy(policy, eval_episodes=10):
    ...
    for _ in range(eval_episodes):
        ...
        while not done:
            ...
            # total_latency += latency
            total_reward += reward
            avge_reward = total_reward /(eval_episodes)
    avge_reward/=eval_episodes       
    # avge_latency = total_latency/eval_episodes
    # print ("---------------------------------------")
    # print ("Average latency over the Evaluation Step: %10f" % (avge_reward))
    # # print ("Average Reward over the Evaluation Step: %10f" % (avge_latency))
    # print ("---------------------------------------")
    # from datetime import datetime
    # now = datetime.now()
    # dt_string = now.strftime("%d/%m/%Y %H:%M:%S")
    
    # with open("EvaluationResult.txt", "a+") as file_object:
    #     # Move read cursor to the start of file.
    #     file_object.seek(0)
    #     # If file is not empty then append '\n'
    #     data = file_object.read(100)
    ...
    #     file_object.write("Evaluation latency = ")
    #     file_object.write(str(avge_reward))
    #     # file_object.write("\n")
    #     # file_object.write("Evaluation reward = ")
    #     # file_object.write(str(avge_latency))
    ...
    df=pd.DataFrame(rew)
    df.to_excel('Evalutionresult.xlsx', sheet_name='new_sheet_name')
