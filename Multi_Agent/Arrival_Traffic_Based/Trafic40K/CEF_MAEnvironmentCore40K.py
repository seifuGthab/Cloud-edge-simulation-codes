        ...
        for i in range(len(latency)):
            ...
            for j in range(len(latency[i])):
                ...
                for k in range(len(latency[i][j])):
                    ...
                    CoreNetLamda = CEF_MAdelayCore40k.get_CoreNetwork_lamda(j,trafic)
                    # print("CoreLamda",CoreLamda)
                    CloudNetLamda = CEF_MAdelayCore40k.get_CloudNetwork_lamda(trafic)
                    ...
                    # CoreLamda = CEF_MAdelayCore40k.get_CoreNetwork_lamda(j,trafic) 
                    ...
                    # else:
                    #     CoreNetLamda = CEF_MAdelayCore40k.get_CoreNetwork_lamda(j,trafic) + ((AccesLamda-AccesNetLamda) * 0.20)
