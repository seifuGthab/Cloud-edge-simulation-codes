        ...
        for i in range(len(latency)):
            ...
            for j in range(len(latency[i])):
                ...
                for k in range(len(latency[i][j])):
                    AccesNetLamda = CEF_delayCore2.get_AccesNetwork_lamda(i,j, action)
                    # print("AccesLamda",AccesNetLamda)
                    CoreNetLamda = CEF_delayCore2.get_CoreNetwork_lamda(j,action)
                    # print("CoreLamda",CoreLamda)
                    CloudNetLamda = CEF_delayCore2.get_CloudNetwork_lamda(action)
                    ...
                    # CoreLamda = CEF_delayCore2.get_CoreNetwork_lamda(j,trafic) 
                    ...
                    # else:
                    #     CoreNetLamda = CEF_delayCore2.get_CoreNetwork_lamda(j,trafic) + ((AccesLamda-AccesNetLamda) * 0.20)
