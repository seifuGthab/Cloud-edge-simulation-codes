...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 24 16:43:36 2022
        ...
        for i in range(len(latency)):
            ...
            for j in range(len(latency[i])):
                ...
                for k in range(len(latency[i][j])):
                    AccesNetLamda = CEF_delayCore5.get_AccesNetwork_lamda(i,k, trafc)
                    # print("AccesLamda",AccesNetLamda)
                    CoreNetLamda = CEF_delayCore5.get_CoreNetwork_lamda(k,trafc)
                    # print("CoreLamda",CoreLamda)
                    CloudNetLamda = CEF_delayCore5.get_CloudNetwork_lamda(trafc)
                    ...
                    # CoreLamda = CEF_delayCore5.get_CoreNetwork_lamda(j,trafic) 
                    ...
                    # else:
                    #     CoreNetLamda = CEF_delayCore5.get_CoreNetwork_lamda(j,trafic) + ((AccesLamda-AccesNetLamda) * 0.20)
