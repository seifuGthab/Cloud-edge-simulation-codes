...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 25 12:23:27 2022
        ...
        for i in range(len(latency)):
            ...
            for j in range(len(latency[i])):
                ...
                for k in range(len(latency[i][j])):
                    AccesNetLamda = CEF_delayCore4.get_AccesNetwork_lamda(i,j, trafc)
                    # print("AccesLamda",AccesNetLamda)
                    CoreNetLamda = CEF_delayCore4.get_CoreNetwork_lamda(j,trafc)
                    # print("CoreLamda",CoreLamda)
                    CloudNetLamda = CEF_delayCore4.get_CloudNetwork_lamda(trafc)
                    ...
                    # CoreLamda = CEF_delayCore4.get_CoreNetwork_lamda(j,trafic) 
                    ...
                    # else:
                    #     CoreNetLamda = CEF_delayCore4.get_CoreNetwork_lamda(j,trafic) + ((AccesLamda-AccesNetLamda) * 0.20)
