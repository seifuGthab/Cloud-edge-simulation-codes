...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 15 14:58:40 2022
        ...
        for i in range(len(latency)):
            ...
            for j in range(len(latency[i])):
                ...
                for k in range(len(latency[i][j])):
                    AccesNetLamda = CEF_MAdelayCore80k.get_AccesNetwork_lamda(i,k, action)
                    # print("AccesLamda",AccesNetLamda)
                    CoreNetLamda = CEF_MAdelayCore80k.get_CoreNetwork_lamda(k,action)
                    # print("CoreLamda",CoreLamda)
                    CloudNetLamda = CEF_MAdelayCore80k.get_CloudNetwork_lamda(action)
                    ...
                    # else:
                    #     CoreNetLamda = CEF_MAdelayCore80k.get_CoreNetwork_lamda(j,trafic) + ((AccesLamda-AccesNetLamda) * 0.20)
                    #     print("Else_CoreNetLamda", CoreNetLamda)    
                    
                    # CloudNetLamda = CEF_MAdelayCore80k.get_CloudNetwork_lamda(trafic) + ((AccesLamda-AccesNetLamda) * 0.60)
                        # print("Else_CoreNetLamda", CoreNetLamda)
...
if __name__ == "__main__":
    ...
    while not done:
        ...
        if done == True:
            ...
            print("Total Latency got : ", env.total_latency/env.NumCoreNetwork)
